 ...
 <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Expnse</li>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                              <table>
                                  <tr>
                                      <td><a href="{{route('pendding.expanse.details',$data->id)}}" class="btn btn-sm btn-primary edit" data-id="{{$data->id ?? ''}}"
                                       ><i class="fa fa-edit"></i>Check Details</a></td>
                               </tr>
                              </table>
                          </td>
                        </tr>
